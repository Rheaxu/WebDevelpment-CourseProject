<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImgPreview.aspx.cs" Inherits="Project_sheetMusicGallery" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var imgUrl = getQueryVariable("imgUrl");
                var imgEle = document.createElement("img");
                imgEle.setAttribute("src", imgUrl);
                imgEle.setAttribute("class", "previewImg");
                document.getElementById("imagePreview").appendChild(imgEle);
            });
        ...
        <div class="container">
            <div class="container rg-image-wrapper viewer">
                <div class="content">
                    <asp:Label runat="server" ID="smsize"></asp:Label>
                    <br />
                    <asp:LoginView runat="server">
                        <AnonymousTemplate>
                            <asp:LinkButton ID="loginToAdd" CssClass="pull-left btn badge" runat="server" Text="Want to add to my Gallery? Please Login" OnClick="loginToAdd_Click" />
                        </AnonymousTemplate>
                        <LoggedInTemplate>
