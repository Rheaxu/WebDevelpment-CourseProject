<%@ Page Language="C#" AutoEventWireup="true" CodeFile="postPhoto.aspx.cs" Inherits="Project_member_postPhoto" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form">
            <h1 class="form-title">
                Add photo to my Gallery
            </h1>
            <p class="border-bottom">
                <asp:Label ID="Label5" runat="server">
                    Inorder to better serve other users, please fill the following information for your work.
                </asp:Label>
            </p>
            <asp:Panel ID="Output" runat="server" Visible="false">
                <asp:Label ID="Label7" runat="server" Text="Label">Add photo succeeded!</asp:Label>
            ...
            <div class="error">
                <div>
                    <asp:RequiredFieldValidator ID="UrlTxtValidation" runat="server" ControlToValidate="UrlTxt"
                        Display="Dynamic" ErrorMessage="Please enter the image url."></asp:RequiredFieldValidator>
                </div>
                <div>
            ...
            <p>
                <label>
                    URL
                    <asp:Label ID="Label4" runat="server" Text="Enter the url of the image"></asp:Label>
                </label>
