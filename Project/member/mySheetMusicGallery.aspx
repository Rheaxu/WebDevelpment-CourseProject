<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mySheetMusicGallery.aspx.cs" Inherits="Project_member_mySheetMusicGallery" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Member's Sheet Music Collection</title>
    <meta charset="UTF-8" />
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container" style="text-align:center">
            <h1 class="profileUsername"><a class="profileUsername" href='profile.aspx?ownername=<%= Request["ownername"] %>' target="_blank"><%=Request["ownername"] %></a>'s Collection</h1>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="popularth"><b>Create Time</b></th>
                        ...
                        <tbody>
                            <asp:Repeater runat="server" ID="mySheetMusicRepeater">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <%# Eval("smTitle") %>
                                        ...
                                        <a href='sheetMusicDetail.aspx?ownername=<%# Eval("ownername") %>&smId=<%# Eval("Id") %>' class="badge blue btn" target="_blank">Detail</a></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </tbody>
