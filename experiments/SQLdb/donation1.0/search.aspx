<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search.aspx.cs" Inherits="Experiments_experimentfiles_SQLdb_search" %>
    ...
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:SqlDataSource 
                ...
                DeleteCommand="DELETE FROM [Sponsored] WHERE [Id] = @Id" 
                InsertCommand="INSERT INTO [Sponsored] ([firstName], [lastName], [country], [continent], [sponsoredId]) VALUES (@firstName, @lastName, @country, @continent, @sponsoredId)" 
                ProviderName="<%$ ConnectionStrings:cs5610.ProviderName %>" 
                SelectCommand="SELECT [Id], [firstName], [lastName], [country], [continent], [sponsoredId] FROM [Sponsored] WHERE continent = @continent" 
                UpdateCommand="UPDATE [Sponsored] SET [firstName] = @firstName, [lastName] = @lastName, [country] = @country, [continent] = @continent, [sponsoredId] = @sponsoredId WHERE [Id] = @Id">
                <DeleteParameters>
