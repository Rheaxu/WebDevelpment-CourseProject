...
/// <summary>
/// Summary description for RemoteMembershipProvider
/// </summary>
public sealed class RemoteMembershipProvider : System.Web.Security.MembershipProvider
{
    private int newPasswordLength = 8;
    private string eventSource = "RemoteMembershipProvider";
    ...
    public RemoteMembershipProvider()
	{
		//
    ...
    public override void Initialize(string name, System.Collections.Specialized.NameValueCollection config)
    {
        ...
        if (String.IsNullOrEmpty(config["description"]))
        {
            ...
            config.Add("description", "My remote ODBC membership provider");
        }
...
;
    ...
    /**
     * 
     * System.WebSecurity.MembershipProvider methods.
     * 
    **/
                        ...
                        out System.Web.Security.MembershipCreateStatus status)
    {
        ...
        if (u == null)
        {
            ...
            OdbcCommand cmd = new OdbcCommand("INSERT INTO Users " +
                "(PKID, Username, Password, Email, PasswordQeustion, " +
            ...
            cmd.Parameters.Add("@PasswordAnswer", OdbcType.VarChar, 255).Value = passwordAnswer;
    ...
    public override bool ChangePassword(string username, string oldPassword, string newPassword)
    {
        ...
        // Use the EncodePassword(pwd) is needed
        cmd.Parameters.Add("@Password", OdbcType.VarChar, 255).Value = newPassword;
        cmd.Parameters.Add("@LastPasswordChangedDate", OdbcType.DateTime).Value = DateTime.Now;
        cmd.Parameters.Add("@Username", OdbcType.VarChar, 255).Value = username;
        cmd.Parameters.Add("@ApplicationName", OdbcType.VarChar, 255).Value = pApplicationName;
    ...
    //
    // MembershipProvider.ChangePasswordQiestionAndAnswer
    //
                    ...
                    string newPasswordAnswer)
    {
        ...
        cmd.Parameters.Add("@Answer", OdbcType.VarChar, 255).Value = newPasswordAnswer;
        cmd.Parameters.Add("@Username", OdbcType.VarChar, 255).Value = username;
        cmd.Parameters.Add("ApplicationName", OdbcType.VarChar, 255).Value = pApplicationName;
    ...
    public override int GetNumberOfUsersOnline()
    {
        ...
        catch (OdbcException e)
        {
            if (WriteExceptionsToEventLog)
            {
                WriteToEventLog(e, "GetNumberOfUserOnline");
                throw new ProviderException(exceptionMessage);
            }
            else
            {
